...
void WeaponPickScene::Draw()const
{
	...
	{
	case 0:
		DrawString(20, 530, "SINGLE_SHOTÇÃê‡ñæ", 0xffffff, true);
		break;
	case 1:
		DrawString(20, 530, "DOUBLE SHOTÇÃê‡ñæ", 0xffffff, true);
		break;
	case 2:
		DrawString(20, 530, "TRIPLE SHOTÇÃê‡ñæ", 0xffffff, true);
		break;
	case 3:
		DrawString(20, 530, "QUAD SHOTÇÃê‡ñæ", 0xffffff, true);
		break;
	case 4:
		DrawString(20, 530, "PENTA SHOTÇÃê‡ñæ", 0xffffff, true);
		break;
	}
	SetFontSize(32);
	for (int i = 0; i < 5; i++)
